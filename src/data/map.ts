...
export const mapMarkers: MapMarker[] = [
  { title: "성서소각장", category: "환경", area: "성서권", issue: "환경시설 부담과 주민 건강 우려", pledge: "정보공개, 주민 의견수렴, 건강영향 조사 요구", x: 29, y: 28 },
  ...
  { title: "달서구청 2청사 부지", category: "공공부지", area: "이곡2동 생활권", issue: "공공부지 활용 방향", pledge: "청년·돌봄·문화·행정 복합거점 검토", x: 54, y: 36 },
  { title: "옛 신당중학교 부지", category: "이주민", area: "신당동", issue: "폐교 활용과 주민교육", pledge: "AI교육·한국어교육과 주민생활시설 연계", x: 26, y: 68 },
  { title: "이곡1동 행정복지센터", category: "행정", area: "이곡1동", issue: "청사 신축과 주민 접근성", pledge: "주민편의·무장애 접근성 점검", x: 86, y: 45 },
  ...
  { title: "이곡역 생활권", category: "안전", area: "이곡2동", issue: "보행약자 이동권과 안심귀가", pledge: "스마트 가로등, 안심벨, 보행환경 개선", x: 48, y: 58 },
